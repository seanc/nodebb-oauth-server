# Contributing to nodebb-oauth-server

First and foremost, thank you! We appreciate that you want to contribute to nodebb-oauth-server, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for nodebb-oauth-server**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for nodebb-oauth-server:

- star the [project](https://github.com/seanc/nodebb-oauth-server)
- tweet your support for nodebb-oauth-server
...
- **version**: please note the version of nodebb-oauth-server are you using
...
[so]: http://stackoverflow.com/questions/tagged/nodebb-oauth-server